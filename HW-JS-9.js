...
console.log(calculateEngravingPrice("скрипт підрахунку вартості гравіювання", 100));
...
console.log(findLongestWord("повертає dgheyjgegbea найдовше htdsbhntsfg слово в цьому ивашимгшмпукшнмипукфшнмпиуфкнмифу рядку"));
